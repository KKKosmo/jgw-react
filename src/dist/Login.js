...
var Login = function (props) {
    ...
    var _c = (0, react_1.useState)(false), redirect = _c[0], setRedirect = _c[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    content = _a.sent();
                    setRedirect(true);
                    console.log("Logged in as " + content.user);
    ...
    return (react_1.default.createElement("form", { onSubmit: submit },
        ...
        react_1.default.createElement("input", { type: "text", className: "form-control", placeholder: "Username", required: true, onChange: function (e) { return setName(e.target.value); } }),
        react_1.default.createElement("input", { type: "password", className: "form-control", placeholder: "Password", required: true, onChange: function (e) { return setPassword(e.target.value); } }),
